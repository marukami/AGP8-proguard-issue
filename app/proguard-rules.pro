## ------------------------
##
## The consumer proguard from mavericks don't seem to work when using
## AGP8 and Gradle 8. If you uncommand the copied rules below the app
## works fine in release mode.
##
## https://github.com/airbnb/mavericks/blob/main/mvrx/build.gradle#L22-L24
## https://github.com/airbnb/mavericks/blob/main/mvrx/proguard-rules.pro
##
## -----------------------
#
#
